...
gulp.task('copy-native', function () {
  return gulp.src('native-styles/**/*')
    .pipe(gulp.dest(paths.appgyverRoot + 'native-styles'));
});
...
gulp.task('copy-loadinghtml', function () {
  return gulp.src('loading.html')
    .pipe(gulp.dest(paths.appgyverRoot));
});
